...
\author{
  \normalsize Author: Andrés Missiego Manjón \\
  \normalsize Tutor: Juan José Cuadrado Gallego \\
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{./images/outlierEffectExample.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{./images/BoxAndWhiskersExample.png}
...
\subsubsection{Pros and cons of this algorithm}
\subsubsection{Algorithm parameters \& Output}
\subsubsection{How to use this algorithm}
\subsubsection{Example of execution of this algorithm}
...
\subsection{Standard Deviation and Mean method}
\subsubsection{Auxiliary functions used}
\subsubsection{Pros and cons of this algorithm}
\subsubsection{Algorithm parameters \& Output}
\subsubsection{How to use this algorithm}
...
\label{outliers:install}

\section{Bibliography}
\begin{itemize}
    \item[\ref{intro:nytimes}] Gladwell, Malcolm. “‘Outliers.’” The New York Times, The New York Times, 28 Nov. 2008, \url{www.nytimes.com/2008/11/30/books/chapters/chapter-outliers.html}.
    
    \item[\ref{outliers:definition}] NIST. “What Are Outliers in the Data?” 7.1.6. What Are Outliers in the Data?, \url{www.itl.nist.gov/}.
    
    \item[\ref{fig:outliers_effect}] Altman, Naomi, and Martin Krzywinski. “Analyzing Outliers: Influential or Nuisance?” Nature News, Nature Publishing Group, 30 Mar. 2016, \url{www.nature.com/articles/nmeth.3812}.

    \item[\ref{fig:box&whiskerslimitsexample}] (TODO), \newline
    \url{https://medium.datadriveninvestor.com/statistical-analysis-part-1-box-and-whisker-plot-for-detecting-outliers-5a260f09cb01}
\end{itemize}

\section{Annex}
\label{outliers:annex}
\subsection{Box and Whiskers Implementation}
